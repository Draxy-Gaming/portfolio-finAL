...
const ProjectDetails = ({
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center w-full h-full overflow-auto backdrop-blur-sm p-4">
      <motion.div
        className="relative w-full max-w-3xl md:max-w-4xl max-h-[90vh] overflow-auto border shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/10"
        initial={{ opacity: 0, scale: 0.5 }}
        animate={{ opacity: 1, scale: 1 }}
      >
        <button
          onClick={closeModal}
          className="absolute p-2 rounded-sm top-5 right-5 bg-midnight hover:bg-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
